    ...
    render(){
        return (
          ...
          <Modal.Body>
              ...
              {this.state.eventDetail.allDay ? <Datetime value={this.state.eventDetail.start} dateFormat="DD-MM-YYYY" 
              ...
              {this.state.eventDetail.allDay ? <Datetime value={this.state.eventDetail.end} dateFormat="DD-MM-YYYY" 
